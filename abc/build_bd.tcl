...
# module references:
# ttl_gate_apd, pcierefclk, spi_inout_mngt, jesd204b_tx_wrapper, jesd_transport, clk_rst_mngt, axi_virtual_controller_wrapper, axi_clock_converter_rtl, fifos_out, mon_ddr_fifos, ddr_data_reg_mngt, ddr_data, axis_burst, decoy, decoy_rng_fifos, spi_inout_mngt, tdc_clk_rst_mngt, tdc_olvds, tdc_ilvds, fifo_gc_tdc_rtl, tdc_reg_mngt, tdc_core
...
proc create_hier_cell_tdc_mngt { parentCell nameHier } {
  ...
  connect_bd_net -net pps200_1  [get_bd_pins pps200] \
  [get_bd_pins tdc_core_0/pps200_i]
...
proc create_hier_cell_clk_rst_buffer { parentCell nameHier } {
  ...
  [get_bd_pins tdc_olvds_0/tdc_refclk]
  ...
  connect_bd_net -net pps200_1  [get_bd_pins pps200] \
  [get_bd_pins tdc_clk_rst_mngt_0/pps200_i]
...
proc create_hier_cell_time_spi { parentCell nameHier } {
  ...
  create_bd_pin -dir O tdc_sck_io
  create_bd_pin -dir O -from 1 -to 0 tdc_ss_io
  create_bd_pin -dir O tdc_mosi_io
  create_bd_pin -dir IO tdc_miso_io
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins tdc_miso_io] \
  [get_bd_pins spi_inout_mngt_0/miso_io]
  ...
  connect_bd_net -net spi_inout_mngt_0_mosi_io  [get_bd_pins spi_inout_mngt_0/mosi_io] \
  [get_bd_pins tdc_mosi_io]
  ...
  connect_bd_net -net spi_inout_mngt_0_sck_io  [get_bd_pins spi_inout_mngt_0/sck_io] \
  [get_bd_pins tdc_sck_io]
  connect_bd_net -net spi_inout_mngt_0_sck_o  [get_bd_pins spi_inout_mngt_0/sck_o] \
  [get_bd_pins axi_quad_spi_0/sck_i]
  connect_bd_net -net spi_inout_mngt_0_ss_io  [get_bd_pins spi_inout_mngt_0/ss_io] \
  [get_bd_pins tdc_ss_io]
...
proc create_hier_cell_decoy { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 3 -to 0 de_rng_flags
  create_bd_pin -dir I rst_clk250
  create_bd_pin -dir I rst_clk80
  create_bd_pin -dir O de_err_ctrl_underrun
  ...
  connect_bd_net -net decoy_0_rng_xfer_dbg  [get_bd_pins decoy_0/rng_xfer_dbg] \
  [get_bd_pins ila_0/probe6]
  connect_bd_net -net decoy_0_rdec_p0_o  [get_bd_pins decoy_0/rdec_p0_r] \
  [get_bd_pins decoy_rng_fifos_0/rdec_p0_i]
  ...
  connect_bd_net -net decoy_0_rng_valid_r  [get_bd_pins decoy_0/dpram_rng_dout] \
  ...
  connect_bd_net -net decoy_rng_fifos_0_de_err_ctrl_underrun  [get_bd_pins decoy_rng_fifos_0/de_err_ctrl_underrun] \
  [get_bd_pins de_err_ctrl_underrun]
  connect_bd_net -net decoy_rng_fifos_0_de_rng_dout2  [get_bd_pins decoy_rng_fifos_0/de_rng_dout2] \
  ...
  connect_bd_net -net pps10_1  [get_bd_pins pps10] \
  [get_bd_pins ila_0/probe5] \
  [get_bd_pins decoy_0/pps10_i]
  connect_bd_net -net pps200_1  [get_bd_pins pps200] \
  [get_bd_pins decoy_0/pps200_i]
  connect_bd_net -net probe7_1  [get_bd_pins rd_en_4] \
  [get_bd_pins decoy_0/rd_en_4] \
  [get_bd_pins decoy_rng_fifos_0/rd_en_4]
  connect_bd_net -net rst_clk250_1  [get_bd_pins rst_clk250] \
  [get_bd_pins decoy_rng_fifos_0/rst_clk250]
  connect_bd_net -net rst_clk80_1  [get_bd_pins rst_clk80] \
  [get_bd_pins decoy_rng_fifos_0/rst_clk80]
  connect_bd_net -net s_axil_aclk_1  [get_bd_pins s_axil_aclk] \
...
proc create_hier_cell_tdc { parentCell nameHier } {
  ...
  [get_bd_pins ila_0/probe1]
  connect_bd_net -net Net  [get_bd_pins tdc_miso_io] \
  [get_bd_pins time_spi/tdc_miso_io]
  ...
  [get_bd_pins stopa_sim_0]
  connect_bd_net -net pps200_1  [get_bd_pins pps200] \
  [get_bd_pins clk_rst_buffer/pps200] \
  [get_bd_pins tdc_mngt/pps200] \
  [get_bd_pins ila_0/probe4]
  connect_bd_net -net gc_rst_1  [get_bd_pins gc_rst] \
  ...
  [get_bd_pins rst_jic_0]
  connect_bd_net -net time_spi_tdc_mosi_io  [get_bd_pins time_spi/tdc_mosi_io] \
  [get_bd_pins tdc_mosi_io]
  connect_bd_net -net time_spi_tdc_sck_io  [get_bd_pins time_spi/tdc_sck_io] \
  [get_bd_pins tdc_sck_io]
  connect_bd_net -net time_spi_tdc_ss_io  [get_bd_pins time_spi/tdc_ss_io] \
  [get_bd_pins tdc_ss_io]
...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  # Create instance: axis_burst_0, and set properties
  set block_name axis_burst
  set block_cell_name axis_burst_0
  if { [catch {set axis_burst_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_burst_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vfifo_ctrl_0_M_AXIS] [get_bd_intf_pins axi_virtual_controll_0/m_axis] [get_bd_intf_pins system_ila_ddr/SLOT_2_AXIS]
  connect_bd_intf_net -intf_net axis_burst_0_m_axis [get_bd_intf_pins axis_burst_0/m_axis] [get_bd_intf_pins axi_virtual_controll_0/s_axis]
  connect_bd_intf_net -intf_net ddr4_0_C0_DDR4 [get_bd_intf_pins c0_ddr4] [get_bd_intf_pins ddr4_0/C0_DDR4]
  connect_bd_intf_net -intf_net ddr_data_0_m_axis [get_bd_intf_pins ddr_data_0/m_axis] [get_bd_intf_pins axis_burst_0/s_axis]
  connect_bd_intf_net -intf_net [get_bd_intf_nets ddr_data_0_m_axis] [get_bd_intf_pins ddr_data_0/m_axis] [get_bd_intf_pins system_ila_ddr/SLOT_1_AXIS]
  ...
  connect_bd_net -net axi_virtual_controll_0_counter_read  [get_bd_pins axi_virtual_controll_0/counter_read] \
  ...
  [get_bd_pins system_ila_ddr/probe25]
  ...
  [get_bd_pins system_ila_ddr/probe22]
  ...
  [get_bd_pins ddr_data_reg_mngt_0/pps200_i] \
  [get_bd_pins ddr_data_0/pps200_i]
...
proc create_hier_cell_clk_rst { parentCell nameHier } {
  ...
  create_bd_pin -dir O pps10
  create_bd_pin -dir O pps200
  ...
  create_bd_pin -dir O rng_rst_clk250_o
  create_bd_pin -dir O rng_rst_clk80_o
  ...
  # Create port connections
  connect_bd_net -net clk250_i_1  [get_bd_pins clk250_i] \
  [get_bd_pins clk_rst_mngt/clk250_i]
  connect_bd_net -net clk80_i_1  [get_bd_pins clk80_i] \
  [get_bd_pins clk_rst_mngt/clk80_i]
  ...
  [get_bd_pins lrst_o]
  connect_bd_net -net clk_rst_mngt_rng_rst_clk200_o  [get_bd_pins clk_rst_mngt/rng_rst_clk200_o] \
  [get_bd_pins rng_rst_clk200_o]
  connect_bd_net -net clk_rst_mngt_rng_rst_clk250_o  [get_bd_pins clk_rst_mngt/rng_rst_clk250_o] \
  [get_bd_pins rng_rst_clk250_o]
  connect_bd_net -net clk_rst_mngt_rng_rst_clk80_o  [get_bd_pins clk_rst_mngt/rng_rst_clk80_o] \
  [get_bd_pins rng_rst_clk80_o]
  ...
  connect_bd_net -net clk_rst_mngt_pps10_o  [get_bd_pins clk_rst_mngt/pps10_o] \
  [get_bd_pins pps10]
  connect_bd_net -net clk_rst_mngt_pps200_o  [get_bd_pins clk_rst_mngt/pps200_o] \
  [get_bd_pins pps200]
...
proc create_hier_cell_fastdac { parentCell nameHier } {
  ...
  create_bd_pin -dir I clk80
  create_bd_pin -dir I -from 3 -to 0 de_rng_flags
  create_bd_pin -dir I rng_rst_clk200
  create_bd_pin -dir I rng_rst_clk80
  create_bd_pin -dir I rng_rst_clk250
  create_bd_pin -dir I de_err_ctrl_underrun
  ...
  connect_bd_net -net clk80_1  [get_bd_pins clk80] \
  [get_bd_pins jesd_transport_0/clk80]
  connect_bd_net -net de_err_ctrl_underrun_1  [get_bd_pins de_err_ctrl_underrun] \
  [get_bd_pins jesd_transport_0/de_err_ctrl_underrun]
  ...
  [get_bd_pins jesd_transport_0/pps200_i]
  connect_bd_net -net gate_pos0_1  [get_bd_pins gate_pos0] \
  ...
  connect_bd_net -net jesd_transport_0_pps_trigger  [get_bd_pins jesd_transport_0/pps_trigger] \
  [get_bd_pins ila_fastdac/probe10]
  connect_bd_net -net jesd_transport_0_rd_en_4  [get_bd_pins jesd_transport_0/rd_en_4] \
  [get_bd_pins rd_en_4] \
  [get_bd_pins ila_fastdac/probe8]
  connect_bd_net -net jesd_transport_0_rd_en_16  [get_bd_pins jesd_transport_0/pps_r] \
  ...
  connect_bd_net -net jesd_transport_0_tx_tready_sync  [get_bd_pins jesd_transport_0/tx_tready_sync] \
  ...
  connect_bd_net -net rng_rst_clk200_1  [get_bd_pins rng_rst_clk200] \
  [get_bd_pins jesd_transport_0/rng_rst_clk200]
  connect_bd_net -net rng_rst_clk250_1  [get_bd_pins rng_rst_clk250] \
  [get_bd_pins jesd_transport_0/rng_rst_clk250]
  connect_bd_net -net rng_rst_clk80_1  [get_bd_pins rng_rst_clk80] \
  [get_bd_pins jesd_transport_0/rng_rst_clk80]
...
proc create_hier_cell_spi_dacs_ltc { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir O dl_mosi_io
  create_bd_pin -dir O -from 2 -to 0 dl_ss_io
  create_bd_pin -dir O dl_sck_io
  create_bd_pin -dir IO dl_miso_io
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins dl_miso_io] \
  [get_bd_pins spi_inout_mngt_0/miso_io]
  connect_bd_net -net axi_quad_spi_0_io0_o  [get_bd_pins axi_quad_spi_0/io0_o] \
  [get_bd_pins spi_inout_mngt_0/in0_i]
  connect_bd_net -net axi_quad_spi_0_io0_t  [get_bd_pins axi_quad_spi_0/io0_t] \
  ...
  [get_bd_pins axi_quad_spi_0/s_axi_aresetn]
  connect_bd_net -net spi_inout_mngt_0_mosi_io  [get_bd_pins spi_inout_mngt_0/mosi_io] \
  [get_bd_pins dl_mosi_io]
  connect_bd_net -net spi_inout_mngt_0_out0_o  [get_bd_pins spi_inout_mngt_0/out0_o] \
  [get_bd_pins axi_quad_spi_0/io0_i]
  connect_bd_net -net spi_inout_mngt_0_out1_o  [get_bd_pins spi_inout_mngt_0/out1_o] \
  [get_bd_pins axi_quad_spi_0/io1_i]
  connect_bd_net -net spi_inout_mngt_0_sck_io  [get_bd_pins spi_inout_mngt_0/sck_io] \
  [get_bd_pins dl_sck_io]
  connect_bd_net -net spi_inout_mngt_0_sck_o  [get_bd_pins spi_inout_mngt_0/sck_o] \
  [get_bd_pins axi_quad_spi_0/sck_i]
  connect_bd_net -net spi_inout_mngt_0_ss_io  [get_bd_pins spi_inout_mngt_0/ss_io] \
  [get_bd_pins dl_ss_io]
  connect_bd_net -net spi_inout_mngt_0_ss_o  [get_bd_pins spi_inout_mngt_0/ss_o] \
  [get_bd_pins axi_quad_spi_0/ss_i]
...
proc create_root_design { parentCell } {
  ...
  set tdc_sck_io [ create_bd_port -dir O -type clk tdc_sck_io ]
  set tdc_ss_io [ create_bd_port -dir O -from 1 -to 0 -type data tdc_ss_io ]
  set tdc_mosi_io [ create_bd_port -dir O -type data tdc_mosi_io ]
  set dl_mosi_io [ create_bd_port -dir O -type data dl_mosi_io ]
  set dl_ss_io [ create_bd_port -dir O -from 2 -to 0 -type data dl_ss_io ]
  set dl_sck_io [ create_bd_port -dir O -type clk dl_sck_io ]
  set dl_miso_io [ create_bd_port -dir IO -type data dl_miso_io ]
  set tdc_miso_io [ create_bd_port -dir IO -type data tdc_miso_io ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT4_REQUESTED_PHASE {56.250} \
    ...
    CONFIG.MMCM_CLKOUT3_PHASE {56.250} \
  ...
  [get_bd_pins spi_dacs_ltc/s_axi_aclk] \
  [get_bd_pins ttl_gate_apd_0/s_axil_aclk]
  ...
  connect_bd_net -net Net  [get_bd_ports tdc_miso_io] \
  [get_bd_pins tdc/tdc_miso_io]
  connect_bd_net -net Net1  [get_bd_ports dl_miso_io] \
  [get_bd_pins spi_dacs_ltc/dl_miso_io]
  ...
  [get_bd_pins ttl_gate_apd_0/clk240_serdes]
  ...
  connect_bd_net -net decoy_de_err_ctrl_underrun  [get_bd_pins decoy/de_err_ctrl_underrun] \
  [get_bd_pins fastdac/de_err_ctrl_underrun]
  ...
  connect_bd_net -net clk_rst_pps10  [get_bd_pins clk_rst/pps10] \
  [get_bd_pins decoy/pps10] \
  [get_bd_pins ttl_gate_apd_0/pps10_i]
  connect_bd_net -net clk_rst_pps200  [get_bd_pins clk_rst/pps200] \
  [get_bd_pins fastdac/pps200] \
  [get_bd_pins tdc/pps200] \
  [get_bd_pins ddr4/pps200] \
  [get_bd_pins decoy/pps200]
  ...
  connect_bd_net -net rng_rst_clk200_1  [get_bd_pins clk_rst/rng_rst_clk200_o] \
  [get_bd_pins fastdac/rng_rst_clk200]
  connect_bd_net -net rst_clk250_1  [get_bd_pins clk_rst/rng_rst_clk250_o] \
  [get_bd_pins decoy/rst_clk250] \
  [get_bd_pins fastdac/rng_rst_clk250]
  connect_bd_net -net rst_clk80_1  [get_bd_pins clk_rst/rng_rst_clk80_o] \
  [get_bd_pins decoy/rst_clk80] \
  [get_bd_pins fastdac/rng_rst_clk80]
  ...
  [get_bd_ports dl_sck_io]
  connect_bd_net -net spi_dacs_ltc_dl_ss_io  [get_bd_pins spi_dacs_ltc/dl_ss_io] \
  [get_bd_ports dl_ss_io]
  ...
  connect_bd_net -net tdc_tdc_mosi_io  [get_bd_pins tdc/tdc_mosi_io] \
  [get_bd_ports tdc_mosi_io]
  connect_bd_net -net tdc_tdc_sck_io  [get_bd_pins tdc/tdc_sck_io] \
  [get_bd_ports tdc_sck_io]
  connect_bd_net -net tdc_tdc_ss_io  [get_bd_pins tdc/tdc_ss_io] \
  [get_bd_ports tdc_ss_io]
