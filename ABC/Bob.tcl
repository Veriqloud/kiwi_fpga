...
#
# Generated by Vivado on Tue Dec 10 18:07:48 CET 2024
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../../../../gittest/okellyfpga/TDC/ip_repo"]"]"\
 "[file normalize "$origin_dir/../../../../gittest/okellyfpga/TTL_test_pack/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
proc create_hier_cell_clk_rst { parentCell nameHier } {
  ...
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.160622",
   "Default View_TopLeft":"-2223,-199",
   "ExpandedHierarchyInLayout":"",
   "PinnedBlocks":"",
...
cr_bd_Bob_top ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files Bob_top.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files Bob_top.bd ] 
set_property IS_ENABLED "1" [get_files Bob_top.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files Bob_top.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files Bob_top.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files Bob_top.bd ] 
set_property PFM_NAME "" [get_files Bob_top.bd ] 
...
set_property USED_IN "synthesis implementation simulation" [get_files Bob_top.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files Bob_top.bd ] 
set_property USED_IN_SIMULATION "1" [get_files Bob_top.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files Bob_top.bd ] 
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "write_incremental_synth_checkpoint" -value "0" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/synth_main" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
set_property -name "steps.synth_design.tcl.pre" -value "" -objects $obj
set_property -name "steps.synth_design.tcl.post" -value "" -objects $obj
...
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "write_incremental_synth_checkpoint" -value "0" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/synth_fb" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
set_property -name "steps.synth_design.tcl.pre" -value "" -objects $obj
set_property -name "steps.synth_design.tcl.post" -value "" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
...
set_property -name "ml_strategy_runs" -value "" -objects $obj
set_property -name "auto_rqs" -value "0" -objects $obj
set_property -name "auto_rqs.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_main" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_main" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Implementation Defaults" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "" -objects $obj
set_property -name "steps.init_design.tcl.post" -value "" -objects $obj
...
set_property -name "ml_strategy_runs" -value "" -objects $obj
set_property -name "auto_rqs" -value "0" -objects $obj
set_property -name "auto_rqs.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_fb" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Bob.srcs/utils_1/imports/impl_fb" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Implementation Defaults" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "" -objects $obj
set_property -name "steps.init_design.tcl.post" -value "" -objects $obj
